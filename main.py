#all imports vi bruger til og få kode til og virke
...
#Variabler og andre ting der laves inden koden køre på loop
...
tm1.number(0)
tm2.number(0)
#her starter while true som gør kode køre hele tiden
while True:
    try:
        # her tjekker vi gps
        ...
        #her tjekker vi likes
        if mqtt.besked2 == "a":
            tm2.number(likes)
            likes = likes + 1
            mqtt.besked2 = ""
        #her tjekker vi tacklinger  
        val = mpu.get_values()
        while val["AcX"] > -5000:
            val = mpu.get_values()
            print(val["AcX"])
            while val["AcX"] < -5000:
                ...
                sleep(5)
                break
        #her tjekker vi batteri leve tid og opdatere vi både adfruit og på vesten 
        ...
        #her er kode der så sørge for at den ene besked bliver resat og starter kode igen med en mulig interrupt
        sleep(0.5)
